    ...
    <main className="bg-white">
      ...
      <section className="max-w-7xl mx-auto px-8 py-32">
        <div className="text-center">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <Link
              href="/film"
              className="px-8 py-4 text-gray-700 font-medium text-lg hover:text-black transition-colors"
            >
              Browse Film
            </Link>
          </div>
      ...
      <section className="border-t border-gray-200 py-24">
        <div className="max-w-4xl mx-auto text-center px-8">
          ...
          <Link
            href="/setup"
            className="inline-block px-8 py-4 bg-black text-white font-medium text-lg rounded-lg hover:bg-gray-800 transition-colors"
          >
